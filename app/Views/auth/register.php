          ...
          <div class="card-body px-5 py-5">
            ...
            <form action="<?= route_to('register') ?>" method="post">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control p_input <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" name="email" aria-describedby="emailHelp" placeholder="<?= lang('Auth.email') ?>" value="<?= old('email') ?>">
              ...
              <p class="sign-up text-center"><?= lang('Auth.alreadyRegistered') ?><a href="<?= route_to('login') ?>"> <?= lang('Auth.signIn') ?></a></p>
            </form>
          </div>
        </div>
      </div>
