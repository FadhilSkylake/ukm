    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h2 class="my-3">Form Tambah Data Profil Dapur Musik</h2>
                        <form action="/pdapus/save" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="slug" value="">
                            <div class="form-group row">
                                <label for="namaukm" class="col-sm-2 col-form-label">Nama UKM</label>
                                <div class="col-sm-10">
