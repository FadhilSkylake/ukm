            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/kldk/update/<?= $ldkkegiatan['id']; ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="slug" value="<?= $ldkkegiatan['slug']; ?>">
                            <input type="hidden" name="dokumentasiLama" value="<?= $ldkkegiatan['dokumentasi']; ?>">
                            <div class="form-group row">
                                <label for="namakegiatan" class="col-sm-2 col-form-label">Nama Kegiatan</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= ($validation->hasError('namakegiatan')) ? 'is-invalid' : ''; ?>" id="namakegiatan" name="namakegiatan" autofocus value="<?= (old('namakegiatan')) ? old('namakegiatan') : $ldkkegiatan['namakegiatan']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tempat_kegiatan" name="tempat_kegiatan" value="<?= (old('tempat_kegiatan')) ? old('tempat_kegiatan') : $ldkkegiatan['tempat_kegiatan']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="waktu_kegiatan" class="col-sm-2 col-form-label">Waktu Kegiatan</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="waktu_kegiatan" name="waktu_kegiatan" value="<?= (old('waktu_kegiatan')) ? old('waktu_kegiatan') : $ldkkegiatan['waktu_kegiatan']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="waktu_dibuat" class="col-sm-2 col-form-label">Waktu Dibuat</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="waktu_dibuat" name="waktu_dibuat" value="<?= (old('waktu_dibuat')) ? old('waktu_dibuat') : $ldkkegiatan['waktu_dibuat']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="dokumentasi" class="col-sm-2 col-form-label">Dokumentasi</label>
                                <div class="col-sm-2">
                                    <img src="/img/<?= $ldkkegiatan['dokumentasi']; ?>" class="img-thumbnail img-preview">
                                </div>
                                <div class="col-sm-10">
                                    ...
                                    <label class="custom-file-label" for="Dokumentasi"><?= $ldkkegiatan['dokumentasi']; ?></label>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-10">
